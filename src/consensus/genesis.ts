...
import { bytesToHex, decodeU16, decodeU32, decodeU128, encodeU128, hexToBytes, parseCanonicalDecimalU64 } from './primitives';
...
export function validateGenesisParams(params: GenesisParams): void {
  ...
  assertConsensus(params.powDifficulty >= 1 && params.powDifficulty <= 255, 'BLK_BAD_CONTENT');
